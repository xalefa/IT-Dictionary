...
public class OCRBinarization extends AppCompatActivity implements View.OnClickListener, AppCompatSeekBar.OnSeekBarChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ocr_binarization);
        ...
        pix = com.googlecode.leptonica.android.ReadFile.readBitmap(OCRCropAndRotate.croppedImage);

        final ArrayAdapter adapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, Arrays.asList("English", "Kurdish"));
        ...
        OCROtsuThresholder otsuThresholder = new OCROtsuThresholder();
    ...
    public void onClick(View view) {
        if(view.getId() == R.id.nextStep) {
            Intent intent = new Intent(OCRBinarization.this, OCRRecognizer.class);
